...
export const SEED_BATCHES: WasteBatch[] = [
  ...
  {
    id: 'batch-groundnut-saurashtra',
    trackingNumber: 'WL-1023',
    wasteType: 'Groundnut Shell',
    category: 'Agricultural',
    quantityTonnes: 8,
    moistureContentPercent: 10.5,
    generatorId: 'usr-generator-1',
    generatorName: 'Saurashtra Agri Cluster Hub',
    generatorType: 'Farmer',
    origin: {
      lat: 22.3039,
      lng: 70.8022,
      address: 'Marketing Yard Highway 8',
      city: 'Rajkot',
      state: 'Gujarat'
    },
    preferredConversion: 'Biochar',
  ...
  {
    id: 'batch-wheat-mehsana',
    trackingNumber: 'WL-1021',
    wasteType: 'Groundnut Shell',
    category: 'Agricultural',
    quantityTonnes: 8,
    actualQuantityTonnes: 7.9,
    actualMoisturePercent: 11.0,
    generatorId: 'usr-generator-1',
    generatorName: 'Mehsana Farmers Federation',
    generatorType: 'Farmer',
    origin: {
      lat: 23.5880,
      lng: 72.3693,
      address: 'Dairy Road APMC Complex',
      city: 'Mehsana',
      state: 'Gujarat'
    },
    preferredConversion: 'Biochar',
    ...
    facilityId: 'fac-biochar-a',
    facilityName: 'BioChar Plant A (Sanand Industrial Eco-Park)',
    processingProgressPercent: 72,
    conversionOutputTonnes: 2.1,
    outputType: 'Biochar',
    createdAt: '2026-09-12T06:00:00.000Z',
    updatedAt: '2026-09-12T10:42:00.000Z'
  },
  {
    id: 'batch-wheat-converted',
    trackingNumber: 'WL-1018',
    wasteType: 'Wheat Straw',
    category: 'Agricultural',
    quantityTonnes: 12,
    actualQuantityTonnes: 11.8,
    actualMoisturePercent: 12.2,
    conversionOutputTonnes: 3.2,
    outputType: 'Biochar',
    generatorId: 'usr-generator-1',
    generatorName: 'Gujarat Agro Producer Cooperative',
    generatorType: 'Farmer',
  ...
  'batch-ahmedabad-demo': [
    {
      ...
      description: '10 tonnes of dry rice husk declared at APMC Market Yard, Vasna Road, Ahmedabad with 11% moisture calibration.',
      location: 'Ahmedabad, Gujarat',
      timestamp: '2026-09-12T08:30:00.000Z',
      actor: 'Gujarat Agro Producer Cooperative',
      txHash: '0x8f2a9c1e4b87d74e'
    },
    {
      id: 'evt-2',
      batchId: 'batch-ahmedabad-demo',
      status: 'matched',
      title: 'Facility Matched',
      description: 'Smart Matching Engine ranked BioChar Plant A (Sanand Industrial Eco-Park) with 92% compatibility score.',
    ...
    },
    {
      ...
      description: 'Optimized 26.4 km logistics route locked via Sanand Highway corridor with CNG Medium Carrier (₹2,140).',
      location: 'Ahmedabad Logistics Hub',
      timestamp: '2026-09-12T09:00:00.000Z',
      actor: 'CarbonLoop Logistics Dispatcher',
      txHash: '0x5e1d4b88a902c317'
    },
    {
      id: 'evt-4',
      batchId: 'batch-ahmedabad-demo',
      status: 'in_transit',
      title: 'In Transit',
      description: 'Carrier vehicle GJ-01-CZ-4412 dispatched from APMC Market Yard with active GPS corridor tracking.',
      location: 'Ahmedabad-Sanand Transit Corridor',
      timestamp: '2026-09-12T09:45:00.000Z',
      actor: 'Gujarat Green Logistics Carrier',
      txHash: '0x2a7f8e09c112d45b'
    },
    {
      id: 'evt-5',
      batchId: 'batch-ahmedabad-demo',
      ...
      description: 'Batch received at BioChar Plant A weighbridge (Net Verified Weight: 10.04 Tonnes, 10.8% Moisture).',
      location: 'Sanand Industrial Eco-Park, Gujarat',
      timestamp: '2026-09-12T10:30:00.000Z',
      actor: 'BioChar Plant A Gate Intake Operator',
      txHash: '0x99b12e34f8a07c61'
    },
    {
      id: 'evt-6',
      batchId: 'batch-ahmedabad-demo',
      ...
      description: 'High-temperature slow pyrolysis executed at 650°C. 10 tonnes Rice Husk transformed into 3.4 tonnes high-grade Biochar.',
      location: 'Pyrolysis Reactor Unit 2, Sanand',
      timestamp: '2026-09-12T11:15:00.000Z',
      actor: 'Senior Pyrolysis Process Engineer',
      txHash: '0x44d82c19e7fa0192'
    },
    {
      id: 'evt-7',
      batchId: 'batch-ahmedabad-demo',
      status: 'converted',
      title: 'Carbon Impact Calculated',
      description: 'Net Impact verified: +2.80 tCO₂e avoided landfill methane + 5.80 tCO₂e biochar fixation - 0.0062 tCO₂e transport = +8.4 tCO₂e.',
      location: 'CarbonLoop Ledger Oracle',
      timestamp: '2026-09-12T11:30:00.000Z',
      actor: 'DeterministicCarbonEngine v2.0',
      txHash: '0x7f83b1657ff1fc53'
    }
  ]
};
...
export const SEED_PASSPORTS: Record<string, CarbonPassport> = {
  'batch-ahmedabad-demo': {
    id: 'pass-ahmedabad-demo',
    batchId: 'batch-ahmedabad-demo',
    passportNumber: 'CLP-PASS-2026-9041',
    qrCodeUrl: 'https://api.qrserver.com/v1/create-qr-code/?size=250x250&data=http://localhost:5173/passport/WL-1024',
    publicVerificationUrl: '/passport/WL-1024',
    digitalSealHash: 'SHA256:7f83b1657ff1fc53b92dc18148a1d65dfc2d4b1fa3d677284addd200126d9069',
    wasteType: 'Rice Husk',
    quantityTonnes: 10,
    generatorName: 'Gujarat Agro Producer Cooperative',
    originName: 'APMC Market Yard, Vasna Road, Ahmedabad',
    facilityName: 'BioChar Plant A (Sanand Industrial Eco-Park)',
    conversionPathway: 'Biochar',
    transportDistanceKm: 26.4,
    avoidedLandfillTonnesCO2e: 2.80,
    conversionBenefitTonnesCO2e: 5.80,
    transportEmissionsKgCO2e: 6.2,
    netCarbonImpactTonnesCO2e: 8.4,
    issuedAt: '2026-09-12T11:30:00.000Z',
    status: 'VERIFIED',
    journeyTimeline: []
  },
  'WL-1024': {
  ...
  'batch-sabarmati-food': {
    ...
    digitalSealHash: 'SHA256:88a1b2c3d4e5f6789012345678abcdef0123456789abcdef0123456789abcdef',
    wasteType: 'Food Waste',
    quantityTonnes: 18,
    generatorName: 'Amul Agro Processing Unit 3',
    ...
    netCarbonImpactTonnesCO2e: 18.0,
